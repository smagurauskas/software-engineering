...
C# has 18 built-in types.

These types are built into .NET, but they have keywords (aliases in C#).

All of these types can be referenced using they full qualifiers, but it is more common practice to reference them by their C# keyword instead.
...
Implicit casts happen from more specific to less specific types, or from equivalent more precise types to less precise types.
